                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="row">
                                ...
                                <div class="mb-5">
                                    <a href="/galeri_foto/{{$data->page + 1}}" class="{{$data->page == ceil($data->jumlah) ? 'disabled' :''}} btn btn-outline-primary text-blue px-4 py-2 rounded-pill float-end">
                                        Next
                                    </a>
                                    <a href="/galeri_foto/{{$data->page - 1}}" class="{{$data->page == 1 ? 'disabled' :''}} btn btn-outline-primary text-blue me-3 px-4 py-2 rounded-pill float-end">
                                        Prev
                                    </a>
                                </div>
                                @endif
